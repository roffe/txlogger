...
$llvm = "https://github.com/mstorsjo/llvm-mingw/releases/download/20251202/llvm-mingw-20251202-ucrt-x86_64.zip"
...
Rename-Item -Path ".\llvm-mingw-20251202-ucrt-x86_64" -NewName "llvm-mingw"
