...
$filesToAdd = "debug.bat", "libusb-1.0.dll", "txlogger.exe", "cangw.exe"
...
scp debug.bat libusb-1.0.dll txlogger.exe cangw.exe txlogger.zip setup.zip roffe@roffe.nu:/webroot/roffe/public_html/txlogger