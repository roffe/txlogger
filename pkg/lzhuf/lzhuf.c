...
unsigned int textsize = 0, codesize = 0;
...
unsigned short GetBit() /* get one bit */
{
    unsigned short i;
...
unsigned short GetByte() /* get one byte */
{
    unsigned short i;
...
/* compression */
unsigned int Encode(unsigned char *in, unsigned int inlen, unsigned char *out) /* compression */
{
...
unsigned int Decode(unsigned char *in, unsigned char *out)
{
    ...
    /* fix so we can call Decode() multiple times */
    getlen = 0;
    getbuf = 0;
